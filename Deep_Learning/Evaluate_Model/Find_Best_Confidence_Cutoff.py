...
def create_metric_chart(path = r'D:\Liver_Disease_Ablation\Predictions\Validation'):
    ...
    for file in image_list:
        ...
        for i, metric_value in enumerate(metric_range):
            ...
            try:
                output_array = remove_non_liver(output_array,min_volume=2, min_area=.25, spacing=truth.GetSpacing())
