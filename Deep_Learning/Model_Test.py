...
from Return_Train_Validation_Generators_TF2 import get_layers_dict_dense, my_UNet
from tensorflow.keras.callbacks import TensorBoard

out_path = r'D:\test_model\test'
layers_dict = get_layers_dict_dense(layers=2,filters=12, growth_rate=4, num_conv_blocks=3)
