...
def return_generators(get_mean_std=False, liver_norm=True,num_patients=1,
    ...
    if cube_size is not None:
        image_processors_train += [
                              Pull_Cube_sitk(annotation_index=2, max_cubes=8, z_images=cube_size[0], rows=cube_size[1],
...
if __name__ == '__main__':
    # return_generators(False, path_extension='Single_Images3D_None', cube_size = (20,120,120), return_test=False)
    pass
