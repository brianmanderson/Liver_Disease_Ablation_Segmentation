...
def return_dictionary(base_dict, optimizer='SGD'):
    if optimizer == 'SGD':
        ...
        #               in [16, 32] for k in [32, 64, 128]]
        dictionary = [
            base_dict(min_lr=1e-6, max_lr=3e-3, layers=1, num_conv_blocks=2,conv_lambda=0, filters=32, max_filters=128),
            base_dict(min_lr=2e-6, max_lr=7e-3, layers=1, num_conv_blocks=3, conv_lambda=0, filters=32,
                      max_filters=128),
            base_dict(min_lr=7e-7, max_lr=5e-3, layers=1, num_conv_blocks=4, conv_lambda=0, filters=32,
                      max_filters=128),

            base_dict(min_lr=5e-7, max_lr=5e-3, layers=2, num_conv_blocks=2, conv_lambda=0, filters=32,
                      max_filters=128),
            base_dict(min_lr=5e-7, max_lr=2e-3, layers=2, num_conv_blocks=2, conv_lambda=1, filters=32,
                      max_filters=128),
            base_dict(min_lr=5e-7, max_lr=2e-3, layers=2, num_conv_blocks=2, conv_lambda=2, filters=32,
                      max_filters=128),

            base_dict(min_lr=1e-7, max_lr=1e-3, layers=3, num_conv_blocks=2, conv_lambda=0, filters=32,
                      max_filters=128),
                      ]
    return dictionary
