...
# Created on 4/4/2020
'''
This is to copy the Disease contour to one called Disease_BMA so I can edit it manually without messing up the original
'''
...
def copy_roi_to_another(patient):
    for case in patient.Cases:
        ...
        if 'Disease_BMA' not in rois_in_case:
            case.PatientModel.CreateRoi(Name="Disease_BMA", Color="Green")
        case.PatientModel.RegionsOfInterest['Disease_BMA'].Color = 'Green'
